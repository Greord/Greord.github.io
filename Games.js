    ...
    function Update() {
        document.getElementById("GameArea").innerHTML = `
            ...
            <div class='eQUICKtionsGrid'>
                <div class='eQUICKtionsCellTop' onclick='CurrentEquation += GameBoard[0]; GameBoard[0] = RI(0, 100); Update();'>${GameBoard[0]}</div>
                <div class='eQUICKtionsCellTop' onclick='CurrentEquation += GameBoard[1]; GameBoard[1] = RI(0, 100); Update();'>${GameBoard[1]}</div>
                <div class='eQUICKtionsCellTop' onclick='CurrentEquation += GameBoard[2]; GameBoard[2] = RI(0, 100); Update();'>${GameBoard[2]}</div>
                <br><br>
                <div class='eQUICKtionsCellMid' onclick='CurrentEquation += GameBoard[3]; GameBoard[3] = RI(0, 100); Update();'>${GameBoard[3]}</div>
                <div class='eQUICKtionsCellMid' onclick='CurrentEquation += GameBoard[4]; GameBoard[4] = RI(0, 100); Update();'>${GameBoard[4]}</div>
                <div class='eQUICKtionsCellMid' onclick='CurrentEquation += GameBoard[5]; GameBoard[5] = RI(0, 100); Update();'>${GameBoard[5]}</div>
                <br><br>
                <div class='eQUICKtionsCellBot' onclick='CurrentEquation += GameBoard[6]; GameBoard[6] = RI(0, 100); Update();'>${GameBoard[6]}</div>
                <div class='eQUICKtionsCellBot' onclick='CurrentEquation += GameBoard[7]; GameBoard[7] = RI(0, 100); Update();'>${GameBoard[7]}</div>
                <div class='eQUICKtionsCellBot' onclick='CurrentEquation += GameBoard[8]; GameBoard[8] = RI(0, 100); Update();'>${GameBoard[8]}</div>
            </div>
