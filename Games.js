...
function getRandomWord() {
  // Check if the Set is loaded and has elements
  if (!englishWords || englishWords.size === 0) { // <-- Use .size for Set
    console.error("Word list is not available.");
    return null;
  }

  // Convert the Set to an Array to allow for random indexing
